...
const Search = ({onSearch}) => {
    ...
    const [searchResults, setSearchResults] = useState({ results: [], total: 0, page_size: 12 });
    ...
    const handleSearch = async (page = 1) => {
        const response = await fetch(`http://localhost:5000/api/v2/search?query=${query}&page=${page}&page_size=${searchResults.page_size}`);
        if (query.trim()) {
        ...
        <div>
            <div className='search-container'>
                ...
                <div className="button-icon-wrapper">
                    ...
                    <Tooltip 
                        placement="top" 
                        title={'Simple Search: xxx xxx \nAdvanced Search: title: xxx AND director: xxx OR plot: "xxx xx" AND cast: xxx'}
                        overlayStyle={{ 
                            maxWidth: '500px',
                            whiteSpace: 'pre-wrap' 
                        }}
